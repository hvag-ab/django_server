...
class MyFile(models.Model):
    ...
    image  = models.ImageField(upload_to='media/images/%Y/%m/%d', null=True, blank=True, verbose_name='图片url') # 默认新增图片的时候会在文件名后面添加token后缀防止覆盖
    file = models.FileField(upload_to=TimeStampFileName('media/'), null=True, blank=True, verbose_name='文件url')
