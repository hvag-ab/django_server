...
# appfont = 'dist'  # vue dist or react build
# STATICFILES_DIRS = [
#     BASE_DIR.parent / f"appfont/{appfont}/static"  # 比如django控制vue启动 需要这里设置vue静态文件存放文件 跟media同级目录新建appfront文件夹 放置前端打包好的代码
# ]
# TEMPLATES[0]['DIRS'] = [BASE_DIR.parent / f"appfont/{appfont}"]
